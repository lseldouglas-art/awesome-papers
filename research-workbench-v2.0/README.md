...
人类主导的科研连续性工作台。当前 **Demo v0.28.0**，包含领域认识、专题建库、研究方案、实际执行与结果记录、研究大纲、正文初稿、全文模板精读及图像工作区。当前验证仍以本地单研究者使用为边界。
...
`v2.0` 表示本地第二代产品目录，`0.28.0` 表示当前 Demo 包版本；旧公开 `v0.2` 是2026-09-04方向计划，不是已经发布的第二代生产版本。旧 v0.1.4 单独保留。

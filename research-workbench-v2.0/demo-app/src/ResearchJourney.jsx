...
export function ResearchJourney({ project, artifact, numbers, disabled, onCommand, onCompare, onDeepen, onSource, onArtifact, onFocusQuestion, historical }) {
